...
public class KeepSessionDemo1 {

    static CookieStore cookieStore = null;
    ObjectMapper mapper;

    public static String HOST = "192.168.0.42";

    public static String DBMGR_BASE_URL = "https://" + HOST + ":4206/resources/";

    public static String USER_NAME = "db__root";

    public static String USER_PWD = "traf123";

    public static String TENANT_NAME = "tenant1";

    public KeepSessionDemo1() {
        mapper = new ObjectMapper();
        login(USER_NAME, USER_PWD, TENANT_NAME);
    }
...
//        System.out.println(sControlStmts);
        KeepSessionDemo1 demo = new KeepSessionDemo1();
